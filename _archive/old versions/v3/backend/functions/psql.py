...
def SELECT_PK_PLAYERSTATS(db_connection):
    ...
    query_select_playerstats = get_query("select", '"matchid"', "playerdata", "playerstats")
...
def SELECT_PK_OBJECTIVES(db_connection):
    ...
    query_select_objectives = get_query("select", '"matchid"', "playerdata", "objectives")
    ...
    if input_type == "match":
        ...
        for key in dict_matches:
            ...
            if new_match.matchid in list_select_match:
                ...
                columns_and_values = f'"matchid" = \'{new_match.matchid}\', "gamestart" = \'{new_match.gamestart}\', "gameend" = \'{new_match.gameend}\', "gameduration" = {new_match.gameduration}, "tournamentcode" = \'{new_match.tournamentcode}\', "gamemode" = {new_match.gamemode}, "season" = \'{new_match.season}\', "patch" = \'{new_match.patch}\', "mapid" = {new_match.mapid}, "earlysurrender_blue" = {new_match.earlysurrender_blue}, "earlysurrender_blue" = {new_match.earlysurrender_red}, "earlysurrender" = {new_match.earlysurrender}'
                query_update = get_query("update", table='"playerdata"."match"', columns_and_values=columns_and_values, key="matchid", value=new_match.matchid)
    ...
    if input_type == "champpool":
        ...
        for champpool in classes_champpool:
            ...
            if primary_key not in list_select_champpool:
                tablename = '"playerdata"."champpool"("puuid", "champ","games_played","kda","kills","deaths","assists","cs","exp","level","gold","visionscore","cs_diff","exp_diff","level_diff","gold_diff","visionscore_diff","summonerspell1","summonerspell2","fav_role","winrate","win_blue","win_red", "season")'
                values = f'\'{new_champpool.puuid}\', \'{new_champpool.champ}\', {new_champpool.games_played}, {new_champpool.kda}, {new_champpool.kills}, {new_champpool.deaths}, {new_champpool.assists}, {new_champpool.cs}, {new_champpool.exp}, {new_champpool.level}, {new_champpool.gold}, {new_champpool.visionscore}, {new_champpool.cs_diff}, {new_champpool.exp_diff}, {new_champpool.level_diff}, {new_champpool.gold_diff}, {new_champpool.visionscore_diff}, \'{new_champpool.summonerspell1}\', \'{new_champpool.summonerspell2}\', \'{new_champpool.fav_role}\', {new_champpool.winrate}, {new_champpool.win_blue}, {new_champpool.win_red}, {new_champpool.season}'
    ...
    if input_type == "mastery":
        ...
        for mastery in mastery_classes:
            ...
            if key in list_mastery:
                ...
                tablename = '"playerdata"."mastery"("puuid", "champ", "masterylevel", "masterypoints")'
                values = f'\'{mastery_table.puuid}\', \'{mastery_table.champ}\',{mastery_table.masterylevel}, {mastery_table.masterypoints}'
